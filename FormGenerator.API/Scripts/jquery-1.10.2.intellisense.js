 ...
 * terms; or (ii) using the files as included with a Microsoft Item subject
 * to that Item's license terms. Microsoft reserves all other rights to the
...
intellisense.annotate(jQuery.fn, {
  ...
  'fadeTo': function() {
    /// <signature>
    ///   <summary>Adjust the opaGovernorate of the matched elements.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
    ///   <param name="opaGovernorate" type="Number">A number between 0 and 1 denoting the target opaGovernorate.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'fadeToggle': function() {
    /// <signature>
    ///   <summary>Display or hide the matched elements by animating their opaGovernorate.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="easing" type="String">A string indicating which easing function to use for the transition.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
