...
namespace FormGenerator.Data.Helpers
{
    public class SecurityHelper
    {
        ...
        private const string _salt = "nEPPnwWf7WiBlvGbaXQS"; // Generated at https://www.random.org/strings
        #region Tokens
        public static string GenerateToken(int userID,int branchID=1)
        {
            ...
            using (HMAC hmac = HMACSHA256.Create(_alg))
            {
                ...
                hashRight = string.Join(":", new string[] { userID.ToString(), DateTime.Now.AddDays(10).Ticks.ToString(), branchID.ToString() });
            }
        ...
        public static int GetBranchIDFromToken(string token)
        {
            if (string.IsNullOrEmpty(token))
                return 1;
            int branchID = 1;
